...
import org.lineageos.settings.bypasscharging.BypassChargingSettingsActivity;
...
public class TileEntryActivity extends Activity {
    ...
    private static final String BYPASS_TILE = "org.lineageos.settings.bypasscharging.BypassChargingTileService";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        } else if (BYPASS_TILE.equals(sourceClassName)) {
            intent = new Intent(this, BypassChargingSettingsActivity.class);
        } else {
